...
/// Dark hero card showing total trip spending and user balance status.
///
/// Tapping the card navigates to the Ledger screen via [onTap].
class ExpenseSummaryHero extends ConsumerWidget {
  final Trip trip;
  final VoidCallback onTap;

  const ExpenseSummaryHero({
    super.key,
    required this.trip,
    required this.onTap,
  });
