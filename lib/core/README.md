...
- **shared_keys.dart**: `SharedKeys` — abstract final class of semantic `Key` constants for testing and accessibility. Covers: ModuleHeader, OfflineBanner, EmptyStateView, InviteCodeDisplay, AppTabBar (parameterized), LoadingButton (parameterized).
