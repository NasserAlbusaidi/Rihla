...
void main() {
  ...
  group('GroupSettingsScreen Phase 29', () {
    ...
    testWidgets('creator sees remove button for non-creator members',
      ...
      expect(
        find.byKey(GroupKeys.removeMemberButton('mem-2')),
        findsOneWidget,
      );
      // Creator should NOT see remove button for themselves
      expect(
        find.byKey(GroupKeys.removeMemberButton('mem-1')),
        findsNothing,
      );
    });
    ...
    testWidgets('tapping delete tile shows confirmation dialog', (tester) async {
      await tester.pumpWidget(
        _wrapCreatorView(
          const GroupSettingsScreen(groupId: 'group-1'),
          prefs,
