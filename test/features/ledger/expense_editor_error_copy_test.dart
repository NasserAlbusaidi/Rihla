...
// #854 regression coverage at the ExpenseEditorBody level: failure snacks
// must show the friendlyMessageFor translation, never the raw exception
// (which leaks '[cloud_firestore/permission-denied] ...' plugin noise).
// The add/edit screen-level pins live in add_expense_screen_test.dart and
// edit_expense_screen_test.dart; this exercises the editor widget directly
// with a real FirebaseException.
final _event = Event(
  id: 'event-1',
  name: 'Marrakech',
  type: EventType.trip,
