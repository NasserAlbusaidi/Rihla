  ...
  group('Offline scenarios — SQLite side-write verification (D-12)', () {
    ...
    test(
      ...
      expect(
        ...
        reason: 'Decimal amount must survive the Firestore->SQLite round-trip',
      );
    ...
    test(
      ...
      expect(ids.contains(expense1.id), isTrue,
          reason: 'expense1 must be in SQLite cache');
      expect(ids.contains(expense2.id), isTrue,
          reason: 'expense2 must be in SQLite cache');
      expect(ids.contains(expense3.id), isTrue,
