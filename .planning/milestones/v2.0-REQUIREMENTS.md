# Requirements Archive: v2.0 Major UI/UX Overhaul
...
- [x] **PLSH-02**: Screen transitions use M3 motion patterns (ContainerTransform, SharedAxis) instead of basic slide animations
